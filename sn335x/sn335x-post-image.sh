#!/bin/sh
# sn335x-post-image.sh for CircuitCo BeagleBone and TI am335x-evm
...
# built:
if [ -e ${BINARIES_DIR}/sn335x-ppu.dtb ] ; then
	GENIMAGE_CFG="${BOARD_DIR}/sn335x-genimage.cfg"
elif [ -e ${BINARIES_DIR}/am335x-bonegreen.dtb ] ; then
